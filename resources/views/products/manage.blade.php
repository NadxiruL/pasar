    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form class="form-horizontal form-material" method="POST" action="{{ route('product.update' , $product->id) }}">
                        ...
                        <div class="form-group mb-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="digital" role="switch" id="flexSwitchCheckChecked" />
